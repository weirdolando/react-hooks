...
Colocation is basically:

> Place code as close to where it's relevant as possible

e.g. Try to move state as close as possible to the component that needs it. It
will greatly improve the performance and maintainability of our application.
